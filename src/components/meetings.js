...
export const MeetingsComponent = {
    render: (container) => {
        ...
        const setupEventListeners = () => {
            ...
            container.querySelectorAll('.meeting-list-card').forEach((card) => {
            ...
            if (form) form.addEventListener('submit', (e) => {
                ...
                const transcriptRaw = (document.getElementById('m-transcript')).value;
